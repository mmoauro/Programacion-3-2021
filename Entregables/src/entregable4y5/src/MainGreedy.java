...
public class MainGreedy {
    public static void main(String[] args) {
        ...
        System.out.println(g.greedy(entrada1));
        System.out.println(g.greedy(entrada2));
        System.out.println(g.greedy(entrada3));
        System.out.println(g.greedy(entrada4));
        System.out.println(g.greedy(entrada5));
        System.out.println(g.greedy(entrada6));
        System.out.println(g.greedy(entrada7));
        System.out.println(g.greedy(entrada8));
        System.out.println(g.greedy(entrada9));
